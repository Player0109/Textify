...
public enum DiagnosticEvent: Encodable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        case let .insertionAttempt(
            ...
            try container.encodeIfPresent(fallbackBlockedReason, forKey: .fallbackBlockedReason)
        ...
        case let .launchAtLoginChange(
            ...
            try container.encode(requestedAction, forKey: .requestedAction)
            try container.encode(statusBefore, forKey: .statusBefore)
            try container.encode(statusAfter, forKey: .statusAfter)
            try container.encode(appLocationCategory, forKey: .appLocationCategory)
