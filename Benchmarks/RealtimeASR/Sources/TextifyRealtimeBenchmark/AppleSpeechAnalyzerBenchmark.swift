...
enum AppleSpeechAnalyzerBenchmark {
    ...
    private static func runAvailable(
        ...
        guard let locale = await SpeechTranscriber.supportedLocale(
            ...
            throw BenchmarkCLIError.benchmarkFailed(
                "Apple SpeechTranscriber does not support English on this Mac"
            )
        }
        ...
        return makeResult(
            ...
            model: "Apple SpeechTranscriber en-US fast volatile results",
